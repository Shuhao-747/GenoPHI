...
def main():
    ...
    output_dir = "/global/scratch/users/anoonan/BRaVE/full_combined/bootstrapping/inverse_frequency_hierarchical_filter_vibrio_50"
    ...
    mem_per_job = "360"                   # Memory per iteration job in GB
