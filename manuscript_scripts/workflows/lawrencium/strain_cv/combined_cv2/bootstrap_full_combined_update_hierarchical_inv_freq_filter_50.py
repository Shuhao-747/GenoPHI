...
def main():
    ...
    interaction_matrix = "/global/scratch/users/anoonan/BRaVE/full_combined/full_interactions_dev.csv"
    output_dir = "/global/scratch/users/anoonan/BRaVE/full_combined/bootstrapping/inverse_frequency_hierarchical_filter_update_50"
    ...
    n_clusters = "50"                    # Number of clusters for hierarchical clustering
