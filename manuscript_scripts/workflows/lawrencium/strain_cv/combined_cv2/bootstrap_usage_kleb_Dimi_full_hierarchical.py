...
def main():
    ...
    interaction_matrix = "/global/scratch/users/anoonan/BRaVE/kleb_Dimi/interactions/phage_host_interactions_full_long.csv"
    output_dir = "/global/scratch/users/anoonan/BRaVE/kleb_Dimi/kleb_Dimi_full_modeling_hierarchical"
