...
def main():
    ...
    output_dir = "/global/scratch/users/anoonan/BRaVE/vibrio/vibrio_modeling_hierarchical"
    ...
    time_limit = "48:00:00"              # Time limit per iteration job
    ...
    max_ram = "240"                       # Max RAM usage in GB
