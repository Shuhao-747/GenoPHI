...
def main():
    ...
    phenotype_matrix = "/global/scratch/users/anoonan/BRaVE/kleb_Dimi/interactions/phage_host_interactions_set1_long.csv"
    output_dir = "/global/scratch/users/anoonan/BRaVE/kleb_Dimi/kleb_Dimi1_hierarchical_inv_freq_filter"
