...
def main():
    ...
    interaction_matrix = "/global/scratch/users/anoonan/BRaVE/kleb_Dimi/interactions/phage_host_interactions_set1_long.csv"
    output_dir = "/global/scratch/users/anoonan/BRaVE/kleb_Dimi/hybrid_bootstrapping/kleb_dimi1/inverse_frequency_hierarchical_filter"
