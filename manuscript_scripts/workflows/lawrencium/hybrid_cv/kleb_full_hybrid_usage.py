...
def main():
    ...
    interaction_matrix = "/global/scratch/users/anoonan/BRaVE/full_combined/updated_interactions/kleb_dimi_full_interactions.csv"
    output_dir = "/global/scratch/users/anoonan/BRaVE/full_combined/hybrid_bootstrapping/inverse_frequency_hierarchical_filter"
